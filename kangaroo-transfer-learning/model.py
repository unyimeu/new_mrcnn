...
class LossLogger(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        # logs is a dictionary with loss and other metrics
        loss = logs.get('loss')
        if loss is not None:
...
# Example usage
log_file_path = 'C:\\Users\\Unyim\\Downloads\\testttt\\loss_folder.txt'
...
def smooth_l1_loss(y_true, y_pred):
    ...
    FILE_PATH = 'C:\\Users\\Unyim\\Downloads\\testttt\\loss_folder.txt'
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            tf.keras.callbacks.ModelCheckpoint(self.checkpoint_path,
                                            verbose=0, save_weights_only=True),loss_logger
        ]
